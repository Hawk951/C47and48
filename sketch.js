...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("------SAVE EARTH------",canvas.width/2-300,canvas.height/2-300);
    text("ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+100);
    stroke("yellow");
    fill("yellow");
    textSize(35);
    textFont("Apple Chancery");
       text(" Ateroids are coming towords Earth.",canvas.width/2-300, canvas.height/2 - 210);
    text("  You have been chosen by your people to stop the asteroids.",canvas.width/2-300,canvas.height/2-170);
    text("  Can you do it?",canvas.width/2-300,canvas.height/2-130);
